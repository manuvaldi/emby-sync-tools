...
def main(argv):
    ...
    try:
        ...
        print_debug(['embysync.py --url1 embyserver1:12345 --username1 useremby1 --password1 mypassword1 --url2 embyserver2:12345 --username2 useremby2 --password2 mypassword2 '])
        sys.exit(2)
    ...
    # Authentication
    api1 = authenticate_token(username=server_username1, password=server_password1, server=server_url1)
    print('User ID 1 : ' + api1["userid"])
    print('  Token 1 : ' + api1["token"])
    print(' Server 1 : ' + api1["server"])
    api2 = authenticate_token(username=server_username2, password=server_password2, server=server_url2)
    print('User ID 2 : ' + api1["userid"])
    print('  Token 2 : ' + api1["token"])
    print(' Server 2 : ' + api1["server"])
